...
FractionKachiL FractionKachiL::operator+(int arg) {
	return FractionKachiL( num + arg * denom, denom );
}
FractionKachiL FractionKachiL::operator-(const FractionKachiL& arg) {
	num = (num * arg.denom) - (denom * arg.num);
	denom = denom * arg.denom;
...
FractionKachiL FractionKachiL::operator*(int arg) {
	return FractionKachiL( num * arg, denom );
}
FractionKachiL FractionKachiL::operator/(const FractionKachiL& arg) {
	num = num * arg.denom;
	denom = denom * arg.num;
...
//	cout << "Class information --" << "\n";
	...
	cout << "  Assignment Number:  Lab 07" 
		<< "\n\t\t      Exercise #1" << "\n";
	
	cout << "  Written by:	      KaChiLau" << "\n";
	
	cout << "  Due Date:           December 10, 2012\n";
